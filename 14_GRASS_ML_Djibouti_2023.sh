...
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC09_L2SP_166052_20230716_20230719_02_T1_SR_B1.TIF output=L_2023_01 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC09_L2SP_166052_20230716_20230719_02_T1_SR_B2.TIF output=L_2023_02 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC09_L2SP_166052_20230716_20230719_02_T1_SR_B3.TIF output=L_2023_03 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC09_L2SP_166052_20230716_20230719_02_T1_SR_B4.TIF output=L_2023_04 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC09_L2SP_166052_20230716_20230719_02_T1_SR_B5.TIF output=L_2023_05 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC09_L2SP_166052_20230716_20230719_02_T1_SR_B6.TIF output=L_2023_06 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC09_L2SP_166052_20230716_20230719_02_T1_SR_B7.TIF output=L_2023_07 extent=region resolution=region
#
g.list rast
# shaded relief
...
# color composites
r.composite blue=L_2023_07 green=L_2023_05 red=L_2023_04 output=L_2023_754 --overwrite
d.mon wx0
d.rast L_2023_754
d.out.file output=Tibet_754 format=jpg --overwrite
#
r.composite blue=L_2023_03 green=L_2023_04 red=L_2023_05 output=L_2023_345 --overwrite
d.mon wx0
d.rast L_2023_345
d.out.file output=Tibet_345 format=jpg --overwrite
#
r.composite blue=L_2023_01 green=L_2023_05 red=L_2023_06 output=L_2023_156 --overwrite
d.mon wx0
d.rast L_2023_156
d.out.file output=Tibet_156 format=jpg --overwrite
#
r.composite blue=L_2023_07 green=L_2023_04 red=L_2023_01 output=L_2023_741 --overwrite
d.mon wx0
d.rast L_2023_741
d.out.file output=Tibet_741 format=jpg --overwrite
#
r.composite blue=L_2023_02 green=L_2023_03 red=L_2023_04 output=L_2023_234 --overwrite
d.mon wx0
d.rast L_2023_234
d.out.file output=Tibet_234 format=jpg --overwrite
#
r.composite blue=L_2023_05 green=L_2023_04 red=L_2023_03 output=L_2023_543 --overwrite
d.mon wx0
d.rast L_2023_543
d.out.file output=Tibet_543 format=jpg --overwrite
#
r.composite blue=L_2023_02 green=L_2023_04 red=L_2023_06 output=L_2023_246 --overwrite
d.mon wx0
d.rast L_2023_246
d.out.file output=Tibet_246 format=jpg --overwrite
#
r.composite blue=L_2023_03 green=L_2023_02 red=L_2023_01 output=L_2023_321 --overwrite
d.mon wx0
d.rast L_2023_321
