...
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC08_L2SP_166052_20150702_20200909_02_T1_SR_B1.TIF output=L_2015_01 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC08_L2SP_166052_20150702_20200909_02_T1_SR_B2.TIF output=L_2015_02 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC08_L2SP_166052_20150702_20200909_02_T1_SR_B3.TIF output=L_2015_03 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC08_L2SP_166052_20150702_20200909_02_T1_SR_B4.TIF output=L_2015_04 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC08_L2SP_166052_20150702_20200909_02_T1_SR_B5.TIF output=L_2015_05 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC08_L2SP_166052_20150702_20200909_02_T1_SR_B6.TIF output=L_2015_06 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Djibouti/LC08_L2SP_166052_20150702_20200909_02_T1_SR_B7.TIF output=L_2015_07 extent=region resolution=region
#
g.list rast
# shaded relief
...
# color composites
r.composite blue=L_2015_07 green=L_2015_05 red=L_2015_04 output=L_2015_754 --overwrite
d.mon wx0
d.rast L_2015_754
d.out.file output=Tibet_754 format=jpg --overwrite
#
r.composite blue=L_2015_03 green=L_2015_04 red=L_2015_05 output=L_2015_345 --overwrite
d.mon wx0
d.rast L_2015_345
d.out.file output=Tibet_345 format=jpg --overwrite
#
r.composite blue=L_2015_01 green=L_2015_05 red=L_2015_06 output=L_2015_156 --overwrite
d.mon wx0
d.rast L_2015_156
d.out.file output=Tibet_156 format=jpg --overwrite
#
r.composite blue=L_2015_07 green=L_2015_04 red=L_2015_01 output=L_2015_741 --overwrite
d.mon wx0
d.rast L_2015_741
d.out.file output=Tibet_741 format=jpg --overwrite
#
r.composite blue=L_2015_02 green=L_2015_03 red=L_2015_04 output=L_2015_234 --overwrite
d.mon wx0
d.rast L_2015_234
d.out.file output=Tibet_234 format=jpg --overwrite
#
r.composite blue=L_2015_05 green=L_2015_04 red=L_2015_03 output=L_2015_543 --overwrite
d.mon wx0
d.rast L_2015_543
d.out.file output=Tibet_543 format=jpg --overwrite
#
r.composite blue=L_2015_02 green=L_2015_04 red=L_2015_06 output=L_2015_246 --overwrite
d.mon wx0
d.rast L_2015_246
d.out.file output=Tibet_246 format=jpg --overwrite
#
r.composite blue=L_2015_03 green=L_2015_02 red=L_2015_01 output=L_2015_321 --overwrite
d.mon wx0
d.rast L_2015_321
...
# perform prediction using r.learn.predict
r.learn.predict group=L_2015 load_model=mlpc_model.gz output=mlpc_classification --overwrite
# check raster categories - they are automatically applied to the classification output
